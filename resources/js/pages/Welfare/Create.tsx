...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/welfare/create' },
];

export default function WelfareCreate({ members, meetings }: { members: Member[]; meetings: Meeting[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Welfare Transaction" />
            <div className="p-4">
                <Card className="mx-auto max-w-2xl">
                    <CardHeader><CardTitle>Record Welfare</CardTitle></CardHeader>
                    <CardContent>
                        <form className="grid gap-4" onSubmit={(e) => { e.preventDefault(); post('/welfare'); }}>
                            ...
                            <div className="grid gap-2 md:grid-cols-3">
                                ...
                                <div className="grid gap-2">
                                    <Label>Type</Label>
                                    <select className="h-10 rounded-md border px-3" value={data.type} onChange={(e) => setData('type', e.target.value)}>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button type="button" variant="outline" asChild><Link href="/welfare">Cancel</Link></Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
